  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-gradient-to-b from-slate-950 via-slate-900 to-slate-950 pt-20">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute top-0 right-1/4 w-96 h-96 bg-cyan-600/20 rounded-full mix-blend-screen filter blur-3xl animate-float"
          style={{ animationDelay: "1s" }}
        ></div>
        <div
          className="absolute bottom-0 left-1/2 w-96 h-96 bg-blue-600/20 rounded-full mix-blend-screen filter blur-3xl animate-float"
      ...
      >
        ...
        >
          An exclusive community of doers, creatives, and professionals who turn
          real projects into results
        </motion.p>
